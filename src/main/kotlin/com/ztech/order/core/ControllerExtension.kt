...
fun responseEntity(status: Status, map: Map<String, Any?>? = null): ResponseEntity<ResponseDto> {
    ...
    return ResponseEntity(
        responseBody(map, statusCode), statusCode
    )

}

fun responseBody(map: Map<String, Any?>?, status: HttpStatus) = ResponseDto(
    map, when (status) {
